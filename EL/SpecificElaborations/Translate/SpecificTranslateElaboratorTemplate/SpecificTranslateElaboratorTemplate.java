...
*	framework that serves as a template for a Translate concrete 
*	elaborator in the DBT reference architecture.
*/

package EL.SpecificElaborations.Translate.SpecificTranslateElaboratorTemplate;  

import EL.Components._Translate;
import EL.Elaborations.AbstractTranslateElaborator;
import EL.ElaborationError;
import java.util.ArrayList;
import EL.ConfigReader.SpecificConfigReader;


public class SpecificTranslateElaboratorTemplate extends AbstractTranslateElaborator {
	...
	*/
	...
	public void generate(){
		System.out.println("This is the Translate template specific elaboration.");
	}
