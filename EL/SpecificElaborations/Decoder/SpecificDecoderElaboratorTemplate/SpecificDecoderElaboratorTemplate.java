...
*	framework that serves as a template for a Decoder concrete 
*	elaborator in the DBT reference architecture.
*/

package EL.SpecificElaborations.Decoder.SpecificDecoderElaboratorTemplate;  

import EL.Components._Decoder;
import EL.Elaborations.AbstractDecoderElaborator;
import EL.ElaborationError;
import java.util.ArrayList;
import EL.ConfigReader.SpecificConfigReader;


public class SpecificDecoderElaboratorTemplate extends AbstractDecoderElaborator {
	...
	*/
	...
	public void generate(){
		System.out.println("This is the Decoder template specific elaboration.");
	}
	...
	*/
	...
	public Object getI_DecodeElaboratorDecode(){
		return null;
	}
	public ArrayList<String> getI_DecodeElaboratorHeaderlist(){
