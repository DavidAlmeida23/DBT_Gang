...
*	framework that serves as a template for a DBTEngine concrete 
*	elaborator in the DBT reference architecture.
*/

package EL.SpecificElaborations.DBTEngine.SpecificDBTEngineElaboratorTemplate;  

import EL.Components._DBTEngine;
import EL.Elaborations.AbstractDBTEngineElaborator;
import EL.ElaborationError;
import java.util.ArrayList;
import EL.ConfigReader.SpecificConfigReader;


public class SpecificDBTEngineElaboratorTemplate extends AbstractDBTEngineElaborator {
	...
	*/
	...
	public void generate(){
		System.out.println("This is the DBTEngine template specific elaboration.");
	}
