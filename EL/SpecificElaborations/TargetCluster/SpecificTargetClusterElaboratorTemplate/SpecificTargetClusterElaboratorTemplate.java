...
*	framework that serves as a template for a TargetCluster concrete 
*	elaborator in the DBT reference architecture.
*/

package EL.SpecificElaborations.TargetCluster.SpecificTargetClusterElaboratorTemplate;  

import EL.Components._TargetCluster;
import EL.Elaborations.AbstractTargetClusterElaborator;
import EL.ElaborationError;
import java.util.ArrayList;
import EL.ConfigReader.SpecificConfigReader;


public class SpecificTargetClusterElaboratorTemplate extends AbstractTargetClusterElaborator {
	...
	*/
	...
	public void generate(){
		System.out.println("This is the TargetCluster template specific elaboration.");
	}
