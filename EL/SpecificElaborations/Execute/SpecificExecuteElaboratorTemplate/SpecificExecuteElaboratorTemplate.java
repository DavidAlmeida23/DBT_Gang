...
*	framework that serves as a template for a Execute concrete 
*	elaborator in the DBT reference architecture.
*/

package EL.SpecificElaborations.Execute.SpecificExecuteElaboratorTemplate;  

import EL.Components._Execute;
import EL.Elaborations.AbstractExecuteElaborator;
import EL.ElaborationError;
import java.util.ArrayList;
import EL.ConfigReader.SpecificConfigReader;


public class SpecificExecuteElaboratorTemplate extends AbstractExecuteElaborator {
	...
	*/
	...
	public void generate(){
		System.out.println("This is the Execute template specific elaboration.");
	}
