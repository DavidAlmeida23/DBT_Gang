...
*	framework that serves as a template for a Architecture concrete 
*	elaborator in the DBT reference architecture.
*/

package EL.SpecificElaborations.Architecture.SpecificArchitectureElaboratorTemplate;  

import EL.Components._Architecture;
import EL.Elaborations.AbstractArchitectureElaborator;
import EL.ElaborationError;
import java.util.ArrayList;
import EL.ConfigReader.SpecificConfigReader;


public class SpecificArchitectureElaboratorTemplate extends AbstractArchitectureElaborator {
	...
	*/
	...
	public void generate(){
		System.out.println("This is the Architecture template specific elaboration.");
	}
