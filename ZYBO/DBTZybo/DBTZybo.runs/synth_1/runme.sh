...
HD_PWD='C:/Users/Public/GIT-DBTGang/DBT_Gang/ZYBO/DBTZybo/DBTZybo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DBT_BD_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source DBT_BD_wrapper.tcl
