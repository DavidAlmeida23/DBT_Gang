...
HD_PWD='C:/Users/Public/GIT-DBTGang/DBT_Gang/ZYBO/DBTZybo/DBTZybo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DBT_BD_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source DBT_BD_wrapper.tcl -notrace
