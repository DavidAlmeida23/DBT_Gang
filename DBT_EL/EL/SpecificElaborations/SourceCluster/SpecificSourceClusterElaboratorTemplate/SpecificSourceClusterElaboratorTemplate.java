...
*	framework that serves as a template for a SourceCluster concrete 
*	elaborator in the DBT reference architecture.
*/

package EL.SpecificElaborations.SourceCluster.SpecificSourceClusterElaboratorTemplate;  

import EL.Components._SourceCluster;
import EL.Elaborations.AbstractSourceClusterElaborator;
import EL.ElaborationError;
import java.util.ArrayList;
import EL.ConfigReader.SpecificConfigReader;


public class SpecificSourceClusterElaboratorTemplate extends AbstractSourceClusterElaborator {
	...
	*/
	...
	public void generate(){
		System.out.println("This is the SourceCluster template specific elaboration.");
	}
