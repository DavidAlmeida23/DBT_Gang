...
*	framework that serves as a template for a TranslationCache concrete 
*	elaborator in the DBT reference architecture.
*/

package EL.SpecificElaborations.TranslationCache.SpecificTranslationCacheElaboratorTemplate;  

import EL.Components._TranslationCache;
import EL.Elaborations.AbstractTranslationCacheElaborator;
import EL.ElaborationError;
import java.util.ArrayList;
import EL.ConfigReader.SpecificConfigReader;


public class SpecificTranslationCacheElaboratorTemplate extends AbstractTranslationCacheElaborator {
