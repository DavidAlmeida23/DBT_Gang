...
public abstract class AbstractDecoderElaborator extends AbstractElaborator implements I_DecodeElaborator{
    protected _Decoder target = null;
    SpecificLoader speload = new SpecificLoader("");    
    
	public void setComponent(Component comp){
		target = (_Decoder) comp;	
	}
